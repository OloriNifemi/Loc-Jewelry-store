    ...
    <footer className="bg-[#050505] border-t border-gold/12 pt-16 pb-8 px-[5vw]">
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-16 pb-12 border-b border-white/5">
        ...
        <div>
          <Link
            to="/"
            className="font-playfair text-2xl tracking-widest text-gold no-underline block mb-4"
          >
            L<span className="italic text-off-white">.</span>O
            <span className="italic text-off-white">.</span>C
          </Link>
          <p className="font-cormorant italic text-base text-[#888] leading-relaxed max-w-xs">
            "Luxury by Olori Concept — where Nigerian elegance meets global
            luxury. Every piece tells your story."
          </p>
          ...
          <ul className="list-none flex flex-col gap-3">
            {[
              ...
              <li key={to}>
                <Link
                  to={to}
                  className="font-montserrat text-[0.82rem] text-[#888] hover:text-gold transition-colors duration-300 no-underline"
                >
                  {label}
                </Link>
              </li>
        ...
        <div>
          ...
          <ul className="list-none flex flex-col gap-3">
            ...
            <li className="font-montserrat text-[0.82rem] text-[#888]">
              Lagos, Nigeria
            </li>
            <li>
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="font-montserrat text-[0.82rem] text-[#888] hover:text-gold transition-colors no-underline"
              >
                WhatsApp Us
              </a>
            </li>
      ...
      <div className="max-w-[1200px] mx-auto flex flex-wrap justify-between items-center gap-4 mt-8">
        <span className="font-montserrat text-[0.72rem] text-[#888]">
          © 2026 Luxury by Olori Concept (L.O.C). All rights reserved. Lagos,
          Nigeria.
        </span>
