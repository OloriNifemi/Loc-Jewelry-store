...
import CartPreviewDropdown from './CartPreviewDropdown.jsx'
  ...
  return (
    <>
          ...
          {links.map(({ to, label }) => (
            <li key={to}>
              <Link
                to={to}
                className=
                {`relative font-montserrat text-[0.7rem] tracking-[0.18em] uppercase no-underline
      ...
      >
        ...
        <div
          className=
          {`absolute top-0 right-0 h-full w-72 max-w-full bg-[#0a0a0a] border-l border-gold/15
            ...
            {links.map(({ to, label }) => (
              <li key={to}>
                <Link
                  ...
                  onClick={close}
                  className=
                  {`block font-montserrat text-[0.75rem] tracking-[0.2em] uppercase
